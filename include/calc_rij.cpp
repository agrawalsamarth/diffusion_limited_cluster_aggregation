...
void postprocessing::dump_hist_file(double bin_size)
{
    //std::cout<<"1"<<std::endl;
    calc_rij();
    double r_max = halfL(0);
    int num_bins = (int)(r_max/bin_size)+1;
    int N_eff    = (numParticles() * (numParticles() - 1))/2;
    int bin;
    //std::cout<<"2"<<std::endl;
    calc_hist(bin_size, num_bins);
    //std::cout<<"3"<<std::endl;
...
void postprocessing::calc_hist(double bin_size, int num_bins)
{

    //std::cout<<"1"<<std::endl;
    double r_max = halfL(0);
    //std::cout<<"2"<<std::endl;
    //int num_bins = (r_max/bin_size)+1;
    //std::cout<<"3"<<std::endl;
    int bin;
    //std::cout<<"4"<<std::endl;
